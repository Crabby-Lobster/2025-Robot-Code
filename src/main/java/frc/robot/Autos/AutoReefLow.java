...
public class AutoReefLow extends Command {
  ScoreSystem scoreSystem;
  PositionContainer positionContainer;

  /** Creates a new AutoReefLow. */
  public AutoReefLow(ScoreSystem scoreSystem, PositionContainer positionContainer) {
  ...
  public void initialize() {
    positionContainer.setState(States.kReefLow);
  }
