...
public class AutoBarge extends Command {
  ScoreSystem scoreSystem;
  PositionContainer positionContainer;

  /** Creates a new AutoBarge. */
  public AutoBarge(ScoreSystem scoreSystem, PositionContainer positionContainer) {
  ...
  public void initialize() {
    positionContainer.setState(States.kBarge);
  }
