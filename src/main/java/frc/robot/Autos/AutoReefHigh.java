...
public class AutoReefHigh extends Command {
  ScoreSystem scoreSystem;
  PositionContainer positionContainer;

  /** Creates a new AutoReefHigh. */
  public AutoReefHigh(ScoreSystem scoreSystem, PositionContainer positionContainer) {
  ...
  public void initialize() {
    positionContainer.setState(States.kReefHigh);
  }
